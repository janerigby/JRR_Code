...
df = pandas.read_excel("events_asrun.xlsx")  # Grab an excel file with a short list of events, time, and label sizes
...
plt.annotate("Jane.Rigby@nasa.gov, as run as of 5/27/2022" , xycoords='figure fraction', xy=(0.7,0.03), fontsize=fs0)
fig.savefig("jwst_visual_commis_timeline_jrigby_asrun_newevents.pdf")
